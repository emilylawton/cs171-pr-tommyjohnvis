...
RecoveryVis.prototype.userChange = function(settings) {
...
RecoveryVis.prototype.copyData = function(data) {
...
RecoveryVis.prototype.filterAge = function(min, max) {
...
RecoveryVis.prototype.filterTeam = function(team) {
  if (team != "ALL") {
    this.data = this.data.filter(function(d) {
      return team == d.team;
    });
...
RecoveryVis.prototype.filterPosition = function(position) {
...
RecoveryVis.prototype.changeGrouping = function(grouping) {
  if (grouping == "year") {
